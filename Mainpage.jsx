...
export default function MainPage() {
    ...
    useEffect(() => {
        const fetchSwipedProfiles = async () => {
            ...
            try {
                ...
                const response = await axios.get(`${API_URL}/swipes/profile/${profileid}/swiper`, {
                    headers: {
                        Authorization: `Bearer ${token}`
                    }
                });
    ...
    const handleSwipe = async (body) => {
        if (currentProfile) {
            try {
                // Creamos el swipe
                const response = await axios.post(`${API_URL}/swipes`, body, {
                    headers: {
                        Authorization: `Bearer ${token}`
                    }
                });
                ...
                const swipesResponse = await axios.get(`${API_URL}/swipes/profile/${profileid}/swiped`, {
                    headers: {
                        Authorization: `Bearer ${token}`
                    }
                });
                ...
                if (matchingSwipe) {
                    ...
                    try {
                        const matchResponse = await axios.post(`${API_URL}/matches`, matchBody, {
                            headers: {
                                Authorization: `Bearer ${token}`
                            }
                        });
